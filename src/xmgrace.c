...
String fallbackResourcesCommon[] = {
    ...
    "XmGrace*menu.newButton.acceleratorText: Ctrl+N",
    "XmGrace*menu.newButton.accelerator: Ctrl<Key>n",
    "XmGrace*menu.openButton.acceleratorText: Ctrl+O",
    "XmGrace*menu.openButton.accelerator: Ctrl<Key>o",
    "XmGrace*menu.saveButton.acceleratorText: Ctrl+S",
    "XmGrace*menu.saveButton.accelerator: Ctrl<Key>s",
    "XmGrace*menu.exitButton.acceleratorText: Ctrl+Q",
    "XmGrace*menu.exitButton.accelerator: Ctrl<Key>q",
    "XmGrace*menu.printSetupButton.acceleratorText: Ctrl+P",
    "XmGrace*menu.printSetupButton.accelerator: Ctrl<Key>p",
    "XmGrace*menu.printButton.acceleratorText: Ctrl+Alt+P",
    "XmGrace*menu.printButton.accelerator: Ctrl Alt<Key>p",
    "XmGrace*menu.undoButton.acceleratorText: Ctrl+Z",
    "XmGrace*menu.undoButton.accelerator: Ctrl<Key>z",
    "XmGrace*menu.redoButton.acceleratorText: Ctrl+Shift+Z",
    "XmGrace*menu.redoButton.accelerator: Ctrl Shift<Key>z",
    "XmGrace*menu.explorerButton.acceleratorText: Ctrl+E",
    "XmGrace*menu.explorerButton.accelerator: Ctrl<Key>e",
    "XmGrace*menu.onContextButton.acceleratorText: Shift+F1",
    "XmGrace*menu.onContextButton.accelerator: Shift<Key>F1",
    "XmGrace*menu.smallerButton.acceleratorText: Ctrl+-",
    "XmGrace*menu.smallerButton.accelerator: Ctrl<Key>minus",
    "XmGrace*menu.largerButton.acceleratorText: Ctrl++",
    "XmGrace*menu.largerButton.accelerator: Ctrl<Key>plus",
    "XmGrace*menu.originalSizeButton.acceleratorText: Ctrl+1",
    "XmGrace*menu.originalSizeButton.accelerator: Ctrl<Key>1",
    "XmGrace*menu.redrawButton.acceleratorText: Ctrl+L",
    "XmGrace*menu.redrawButton.accelerator: Ctrl<Key>l",
    "XmGrace*menu.acceleratorText: Ctrl+F",
    "XmGrace*menu.accelerator: Ctrl<Key>f",
    "XmGrace*menu.acceleratorText: Ctrl+G",
    "XmGrace*menu.accelerator: Ctrl<Key>g",
